...
if __name__ == '__main__':
  notebooks_executor_op = create_component_from_func(
      ...
      packages_to_install=['google-api-python-client==2.17.0'],
      output_component_file='component.yaml',
      annotations={
        "author": "Matthieu Mayran",
        "canonical_location": "https://raw.githubusercontent.com/m-mayran/pipelines/blob/notebooks_executor/components/google-cloud/google_cloud_pipeline_components/experimental/notebooks/component.yaml",
      },
